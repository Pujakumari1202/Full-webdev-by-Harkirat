/*
write a function which takes 2 parameter and return true /false if those are anagram or not

eg-aab or baa true
eg(aahhcc,ccbbaa) true
*/

/*first way to do this is sort the string then check if str1 and str2 are equal  then return true else false
 */
